    ...
    <div className='Post'>
        ...
        <div className='post-info'>
            <div className='postCats'>
                <span className='postCat' > Frienship</span>
                <span className='postCat' >Life</span>
            </div>
<span className='postTitle'> Being in a group of friends</span>
<span className='postDate'> 26 days ago</span>
        </div>
...
these people turn out to be your life partners. The best feeling in life is waking up and knowing that you have your people no matter what. People who know you more than yourself, people who can tell when you need saving without asking, people who know what dress or food you'd go with, and many other things. They know when you lying, when you're sad and when you’re happy. For me, this is the purest form of love.<br />
